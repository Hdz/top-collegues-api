...
import dev.topcolleguesapi.dto.InfosAuthentification;
import dev.topcolleguesapi.dto.UtilisateurConnecte;
...
public class AuthController {
	...
	public ResponseEntity authenticate(@RequestBody @Valid InfosAuthentification authenticationRequest,
		...
		// On se connecte
		ResponseEntity<UtilisateurConnecte> respHttp = rt.postForEntity("https://drouaud-colleguesapi.herokuapp.com/auth", authenticationRequest, UtilisateurConnecte.class);
		
		// On récupère les infos du collègue dont l'url de sa photo
		ResponseEntity<Participant> respHttp2 = rt.exchange(RequestEntity
				.get(new URI("https://drouaud-colleguesapi.herokuapp.com/email"))
